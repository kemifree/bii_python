...
params = {
'dateRange':recent_30+'|'+yesterday, #默认选择昨天
'dateType':'recent30',
'device':0,#默认选择全部
...
def url_recent_30_download(driver=driver,path=path,url_base=url_base,params=params):
    #默认取前1天数据：    
    ...
    for key in  device_dict:
        ...
        print('正在下载最近30天----'+device_name+'-商品效果----请耐心等待')
...
if __name__ == "__main__":
    ...
    engine.drop
    #插入最近7天数据
    url_recent_30_download(driver=driver,path=path,url_base=url_base,params=params)
